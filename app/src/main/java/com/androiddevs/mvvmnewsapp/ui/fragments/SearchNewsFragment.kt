...
//                        val totalPages = newsResponse.totalResults / SyncStateContract.Constants.QUERY_PAGE_SIZE + 2
...
//                    }
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isTotalMoreThanVisible = totalItemCount >= Constants.SIZE_PREFIX_LENGTH
